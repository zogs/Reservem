...
namespace Zogs\ContactBundle\Entity;
 ...
 * @ORM\Entity(repositoryClass="Zogs\ContactBundle\Entity\ContactRepository")
 */
class Contact {
	...
	*/
     ...
     * @return Contact
     */
    public function setUser(\Zogs\UserBundle\Entity\User $user = null)
    {
        $this->user = $user;
