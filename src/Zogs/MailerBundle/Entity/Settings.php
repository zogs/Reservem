...
namespace Zogs\MailerBundle\Entity;

use Doctrine\ORM\Mapping as ORM;
use Symfony\Component\Validator\Constraints as Assert;

use Zogs\UserBundle\Entity\Settings as BaseSettings;
/**
 * @ORM\Entity
 * @ORM\HasLifecycleCallbacks
 * @ORM\Table(name="users_settings_mailing")
  * @ORM\Entity(repositoryClass="Zogs\MailerBundle\Entity\SettingsRepository")
 */
class Settings
{
    ...
    */
     ...
     * isAuthorized
     *
     * @param Zogs\MailerBundle\Entity\Settings const
     * @return boolean
     */
