<?php
namespace Zogs\MailerBundle\Form\Type;
...
use Zogs\MailerBundle\Form\DataTransformer\ZogsMailingSettingsToSettingsTransformer;

class ZogsMailerSettingsType extends AbstractType
{
    private $user;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('event_cancel_participation','choice',array(
                ...
                ->addModelTransformer(new ZogsMailingSettingsToSettingsTransformer($this->user))                 
    		;
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
	{
	    $resolver->setDefaults(array(
	        ...
	        'data_class' => 'Zogs\MailerBundle\Entity\Settings',
