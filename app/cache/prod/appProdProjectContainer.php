...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_6e54159f5122a4c49ad132ade101d5b5e6ab80acd2677eb6a008e8d942cff574');
        return $instance;
    }
    ...
    {
        return $this->services['fos_comment.manager.comment.default'] = new \FOS\CommentBundle\Entity\CommentManager($this->get('event_dispatcher'), $this->get('fos_comment.sorting_factory'), $this->get('fos_comment.entity_manager'), 'Zogs\\CommentBundle\\Entity\\Comment');
    }
    ...
    {
        return $this->services['fos_comment.manager.thread.default'] = new \FOS\CommentBundle\Entity\ThreadManager($this->get('event_dispatcher'), $this->get('fos_comment.entity_manager'), 'Zogs\\CommentBundle\\Entity\\Thread');
    }
    ...
    {
        return $this->services['jms_i18n_routing.loader'] = new \JMS\I18nRoutingBundle\Router\I18nLoader(new \JMS\I18nRoutingBundle\Router\DefaultRouteExclusionStrategy(), new \JMS\I18nRoutingBundle\Router\DefaultPatternGenerationStrategy('prefix_except_default', $this->get('translator.default'), array(0 => 'fr', 1 => 'en'), __DIR__, 'routes', 'fr'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($q, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'main', $a, $d), 2 => $s, 3 => $u, 4 => $w, 5 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $r, $g, $a, $d, true), 6 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '56445fbd956cb', $a, $g), 7 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($b, $c, $this->get('hwi_oauth.user_checker'), 'main', $i, $a, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $d), 8 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $i, $q, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $e, 'main', $this->get('entry_point.user_login'), NULL, NULL, $a));
    }
    ...
    protected function getTwigService()
    {
        ...
        $d->setContainer($this);
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => ':Form:field.html.twig', 2 => ':Form:fields.html.twig', 3 => ':Form:buttons.html.twig', 4 => 'ZogsWorldBundle:Form:location_selectboxs.html.twig', 5 => 'ZogsUtilsBundle:Form:field_tags.html.twig'), 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'FOSCommentBundle', 1 => 'ZogsUtilsBundle', 2 => 'ZogsStyleBundle', 3 => 'CrcReservBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
