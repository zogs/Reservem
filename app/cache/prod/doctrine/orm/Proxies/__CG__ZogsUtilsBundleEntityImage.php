...
namespace Proxies\__CG__\Zogs\UtilsBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Image extends \Zogs\UtilsBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Zogs\\UtilsBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'Zogs\\UtilsBundle\\Entity\\Image' . "\0" . 'updated', '' . "\0" . 'Zogs\\UtilsBundle\\Entity\\Image' . "\0" . 'path', 'file', 'filename', '' . "\0" . 'Zogs\\UtilsBundle\\Entity\\Image' . "\0" . 'filenameForRemove');
        }
