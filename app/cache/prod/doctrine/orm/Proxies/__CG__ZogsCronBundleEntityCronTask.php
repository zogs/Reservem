...
namespace Proxies\__CG__\Zogs\CronBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class CronTask extends \Zogs\CronBundle\Entity\CronTask implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Zogs\\CronBundle\\Entity\\CronTask' . "\0" . 'id', '' . "\0" . 'Zogs\\CronBundle\\Entity\\CronTask' . "\0" . 'name', '' . "\0" . 'Zogs\\CronBundle\\Entity\\CronTask' . "\0" . 'commands', '' . "\0" . 'Zogs\\CronBundle\\Entity\\CronTask' . "\0" . 'interval', '' . "\0" . 'Zogs\\CronBundle\\Entity\\CronTask' . "\0" . 'lastrun');
        }
