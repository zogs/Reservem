 ...
 */
class Region extends \Zogs\WorldBundle\Entity\Region implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Zogs\\WorldBundle\\Entity\\Region' . "\0" . 'id', '' . "\0" . 'Zogs\\WorldBundle\\Entity\\Region' . "\0" . 'region_id', '' . "\0" . 'Zogs\\WorldBundle\\Entity\\Region' . "\0" . 'parent_id', '' . "\0" . 'Zogs\\WorldBundle\\Entity\\Region' . "\0" . 'name', '' . "\0" . 'Zogs\\WorldBundle\\Entity\\Region' . "\0" . 'lang', '' . "\0" . 'Zogs\\WorldBundle\\Entity\\Region' . "\0" . 'characters');
        }
