 ...
 */
class Avatar extends \Zogs\UserBundle\Entity\Avatar implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Zogs\\UserBundle\\Entity\\Avatar' . "\0" . 'id', '' . "\0" . 'Zogs\\UserBundle\\Entity\\Avatar' . "\0" . 'updated', '' . "\0" . 'Zogs\\UserBundle\\Entity\\Avatar' . "\0" . 'path', 'file', 'filename', '' . "\0" . 'Zogs\\UserBundle\\Entity\\Avatar' . "\0" . 'filenameForRemove');
        }
    ...
    public function isDefaultAvatar()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isDefaultAvatar', array());

        return parent::isDefaultAvatar();
    }
    ...
    public function getSavingFilename()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSavingFilename', array());

        return parent::getSavingFilename();
    }
