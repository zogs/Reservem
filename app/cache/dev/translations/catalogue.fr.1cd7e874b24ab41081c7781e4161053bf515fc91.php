...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'registration.flash.user_created' => 'Bravo ! Vous êtes maintenant enregistré(e) !',
...
',
  ...
  'ZogsUtilsBundle' => 
  array (
    'days.day.monday' => 'lundi',
    'days.day.tuesday' => 'mardi',
    'days.day.wednesday' => 'mercredi',
    'days.day.thursday' => 'jeudi',
    'days.day.friday' => 'vendredi',
    'days.day.saturday' => 'samedi',
    'days.day.sunday' => 'dimanche',
  ),
  'ZogsUserBundle' => 
  array (
    'user.type.person' => 'particulier',
    'user.type.asso' => 'association',
    'user.type.pro' => 'profesionnel',
    'user.types.person' => 'particuliers',
    'user.types.asso' => 'associations',
    'user.types.pro' => 'profesionnels',
    'form.error.username.taken' => 'Ce nom est déjà pris',
    'form.error.username.itsyours' => 'Ceci est déjà votre login !',
    'form.error.email.taken' => 'Cet email est déjà pris',
    'form.error.email.itsyours' => 'Ceci est déjà votre email de contact',
  ),
  'ZogsWorldBundle' => 
  array (
    'world.country.label' => 'Pays',
    'world.country.placeholder' => 'Votre pays...',
    'world.region.label' => 'Région',
    'world.region.placeholder' => 'Votre région...',
    'world.departement.label' => 'Département',
    'world.departement.placeholder' => 'Votre département...',
    'world.district.label' => '',
    'world.district.placeholder' => '',
    'world.division.label' => '',
    'world.division.placeholder' => '',
    'world.city.label' => 'Ville',
    'world.city.placeholder' => 'Votre ville...',
  ),
  'messages' => 
  array (
